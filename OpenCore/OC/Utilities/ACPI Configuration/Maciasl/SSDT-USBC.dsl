DefinitionBlock ("", "SSDT", 1, "RLJ", "ARTB3", 0x00000000)
{
    ...
    Scope (_SB.PCI0.RP17)
    {
        ...
        Device (UPSB)
        {
                        ...
                        Local0 = Package (0x25)
                            {
                                ...
                                Buffer (0x2E)
                                {
                                    "Intel Alpine Ridge JHL6240 Thunderbolt 3 NHI "
                                }, 

                                "name", 
                                Buffer (0x24)
                                {
                                    "Intel Alpine Ridge TB-3 Controller "
                                }, 
                                ...
                                Buffer (One)
                                {
                                    /* 0000 */  0x76, 0x00, 0xC1, 0x71, 0xC5, 0xBE, 0x49, 0x01,  // v..q..I.
                                    ...
                                    /* 0048 */  0x50, 0x00, 0x00, 0x05, 0x8A, 0x50, 0x00, 0x00,  // P....P..
                                    /* 0050 */  0x02, 0xCB, 0x0D, 0x01, 0x41, 0x70, 0x70, 0x6C,  // ....Appl
                                    /* 0058 */  0x65, 0x20, 0x49, 0x6E, 0x63, 0x2E, 0x00, 0x0C,  // e Inc...
                                    /* 0060 */  0x02, 0x4D, 0x61, 0x63, 0x69, 0x6E, 0x74, 0x6F,  // .Macinto
                                    /* 0068 */  0x73, 0x68, 0x00                                 // sh.
                                }, 
                        ...
                        Local0 = Package (0x16)
                            {
                                ...
                                Buffer (0x1A)
                                {
                                    "Intel Alpine Ridge USB-C "
                                }, 

                                "name", 
                                Buffer (0x25)
                                {
                                    "Intel Alpine Ridge USB-C Controller "
                                }, 
            ...
            Device (DSB3)
            {
                ...
                Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                {
                    Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.SECB */
                }
                ...
                Device (UPS0)
                {
                    ...
                    Device (DSB0)
                    {
                        ...
                        Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                        {
                            Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB0.SECB */
                        }
                    ...
                    Device (DSB3)
                    {
                        ...
                        Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                        {
                            Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB3.SECB */
                        }
                        ...
                        Device (UPS0)
                        {
                            ...
                            Device (DSB0)
                            {
                                ...
                                Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                                {
                                    Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB3.UPS0.DSB0.SECB */
                                }
                            ...
                            Device (DSB3)
                            {
                                ...
                                Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                                {
                                    Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB3.UPS0.DSB3.SECB */
                                }
                            ...
                            Device (DSB4)
                            {
                                ...
                                Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                                {
                                    Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB3.UPS0.DSB4.SECB */
                                }
                            ...
                            Device (DSB5)
                            {
                                ...
                                Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                                {
                                    Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB3.UPS0.DSB5.SECB */
                                }
                            ...
                            Device (DSB6)
                            {
                                ...
                                Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                                {
                                    Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB3.UPS0.DSB6.SECB */
                                }
                    ...
                    Device (DSB4)
                    {
                        ...
                        Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                        {
                            Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB4.SECB */
                        }
                        ...
                        Device (UPS0)
                        {
                            ...
                            Device (DSB0)
                            {
                                ...
                                Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                                {
                                    Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB4.UPS0.DSB0.SECB */
                                }
                            ...
                            Device (DSB3)
                            {
                                ...
                                Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                                {
                                    Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB4.UPS0.DSB3.SECB */
                                }
                            ...
                            Device (DSB4)
                            {
                                ...
                                Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                                {
                                    Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB4.UPS0.DSB4.SECB */
                                }
                            ...
                            Device (DSB5)
                            {
                                ...
                                Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                                {
                                    Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB4.UPS0.DSB5.SECB */
                                }
                            ...
                            Device (DSB6)
                            {
                                ...
                                Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                                {
                                    Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB4.UPS0.DSB6.SECB */
                                }
                    ...
                    Device (DSB5)
                    {
                        ...
                        Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                        {
                            Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB5.SECB */
                        }
                    ...
                    Device (DSB6)
                    {
                        ...
                        Method (_BBN, 0, NotSerialized)  // _BBN: BIOS Bus Number
                        {
                            Return (SECB) /* \_SB_.PCI0.RP17.UPSB.DSB3.UPS0.DSB6.SECB */
                        }
