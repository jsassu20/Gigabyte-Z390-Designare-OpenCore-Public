 ...
 *
 * Disassembly of SSDT-8.aml, Sun May 16 12:34:45 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000E96 (3734)
 *     Revision         0x02
 *     Checksum         0x8D
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
...
DefinitionBlock ("", "SSDT", 2, "ALASKA", "A M I", 0x00000000)
{
    ...
    {
        If (CondRefOf (\_SB.PCI0.RP05.UPSB))
        {
                    ...
                    Device (XHC2)
                    {
                        ...
                        Device (RHUB)
                        {
                            ...
                            Method (TPLD, 2, Serialized)
                            {
                                ...
                                CreateField (DerefOf (Index (PCKG, Zero)), Zero, 0x07, REV)
                                Store (One, REV) /* \_SB_.PCI0.RP05.UPSB.TBDU.XHC_.RHUB.TPLD.REV_ */
                                CreateField (DerefOf (Index (PCKG, Zero)), 0x40, One, VISI)
                                Store (Arg0, VISI) /* \_SB_.PCI0.RP05.UPSB.TBDU.XHC_.RHUB.TPLD.VISI */
                                CreateField (DerefOf (Index (PCKG, Zero)), 0x57, 0x08, GPOS)
                                Store (Arg1, GPOS) /* \_SB_.PCI0.RP05.UPSB.TBDU.XHC_.RHUB.TPLD.GPOS */
                                CreateField (DerefOf (Index (PCKG, Zero)), 0x4A, 0x04, SHAP)
                                Store (One, SHAP) /* \_SB_.PCI0.RP05.UPSB.TBDU.XHC_.RHUB.TPLD.SHAP */
                                CreateField (DerefOf (Index (PCKG, Zero)), 0x20, 0x10, WID)
                                Store (0x08, WID) /* \_SB_.PCI0.RP05.UPSB.TBDU.XHC_.RHUB.TPLD.WID_ */
                                CreateField (DerefOf (Index (PCKG, Zero)), 0x30, 0x10, HGT)
                                Store (0x03, HGT) /* \_SB_.PCI0.RP05.UPSB.TBDU.XHC_.RHUB.TPLD.HGT_ */
                                Return (PCKG) /* \_SB_.PCI0.RP05.UPSB.TBDU.XHC_.RHUB.TPLD.PCKG */
                            }
                            ...
                            Method (TUPC, 2, Serialized)
                            {
                                ...
                                Store (Arg0, Index (PCKG, Zero))
                                Store (Arg1, Index (PCKG, One))
                                Return (PCKG) /* \_SB_.PCI0.RP05.UPSB.TBDU.XHC_.RHUB.TUPC.PCKG */
                            }
    ...
    {
        If (CondRefOf (\_SB.PCI0.RP21.UPSB))
        {
            Scope (\_SB.PCI0.RP21.UPSB)
            {
                Name (TURP, 0x09)
                Device (DSB2)
                {
                    ...
                    Device (XHC3)
                    {
                        ...
                        Device (RHUB)
                        {
                            ...
                            Method (TPLD, 2, Serialized)
                            {
                                ...
                                CreateField (DerefOf (Index (PCKG, Zero)), Zero, 0x07, REV)
                                Store (One, REV) /* \_SB_.PCI0.RP21.UPSB.TBDU.XHC_.RHUB.TPLD.REV_ */
                                CreateField (DerefOf (Index (PCKG, Zero)), 0x40, One, VISI)
                                Store (Arg0, VISI) /* \_SB_.PCI0.RP21.UPSB.TBDU.XHC_.RHUB.TPLD.VISI */
                                CreateField (DerefOf (Index (PCKG, Zero)), 0x57, 0x08, GPOS)
                                Store (Arg1, GPOS) /* \_SB_.PCI0.RP21.UPSB.TBDU.XHC_.RHUB.TPLD.GPOS */
                                CreateField (DerefOf (Index (PCKG, Zero)), 0x4A, 0x04, SHAP)
                                Store (One, SHAP) /* \_SB_.PCI0.RP21.UPSB.TBDU.XHC_.RHUB.TPLD.SHAP */
                                CreateField (DerefOf (Index (PCKG, Zero)), 0x20, 0x10, WID)
                                Store (0x08, WID) /* \_SB_.PCI0.RP21.UPSB.TBDU.XHC_.RHUB.TPLD.WID_ */
                                CreateField (DerefOf (Index (PCKG, Zero)), 0x30, 0x10, HGT)
                                Store (0x03, HGT) /* \_SB_.PCI0.RP21.UPSB.TBDU.XHC_.RHUB.TPLD.HGT_ */
                                Return (PCKG) /* \_SB_.PCI0.RP21.UPSB.TBDU.XHC_.RHUB.TPLD.PCKG */
                            }
                            ...
                            Method (TUPC, 2, Serialized)
                            {
                                ...
                                Store (Arg0, Index (PCKG, Zero))
                                Store (Arg1, Index (PCKG, One))
                                Return (PCKG) /* \_SB_.PCI0.RP21.UPSB.TBDU.XHC_.RHUB.TUPC.PCKG */
                            }
